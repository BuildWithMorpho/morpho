...
- Updated dependencies [20ad8dc]
  - @builder.io/morpho@0.5.25

## 0.5.24

### Patch Changes

- 995eb95: [All] Add new `explicitBuildFileExtensions` to `MorphoConfig`. This allows users to manage the extension of some components explicitly. This is very useful for plugins:
...
- 341f281: [All] add additional `build` type for [Plugin](https://github.com/BuilderIO/morpho/blob/main/packages/core/src/types/plugins.ts) to allow users to run plugins before/after cli build process
- Updated dependencies [995eb95]
- Updated dependencies [341f281]
- Updated dependencies [b387d21]
  - @builder.io/morpho@0.5.24
