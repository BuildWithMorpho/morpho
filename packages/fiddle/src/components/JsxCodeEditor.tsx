...
import { rules, configs as lintConfigs } from '@builder.io/eslint-plugin-morpho';

const JsxRuntimeTypes = require('!!raw-loader!@builder.io/morpho/jsx-runtime').default;
const MorphoTypes = require('!!raw-loader!@builder.io/morpho/types').default;
...
export function JsxCodeEditor(props: MonacoEditorProps) {
  ...
  useEffect(() => {
    ...
    monaco.languages.typescript.typescriptDefaults.addExtraLib(
      MorphoTypes,
      'file:///node_modules/@builder.io/morpho/index.d.ts',
    );
    monaco.languages.typescript.typescriptDefaults.addExtraLib(
      JsxRuntimeTypes,
