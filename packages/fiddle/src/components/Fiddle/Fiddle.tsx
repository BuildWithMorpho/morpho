import type { MorphoComponent, ToReactOptions } from '@builder.io/morpho';
import {
  Button,
  Divider,
  FormControlLabel,
...
const morphoCore = () => {
  console.log('importing morpho...');
  return import('@builder.io/morpho');
};
...
export default function Fiddle() {
  ...
  const state = useLocalObservable(() => ({
    ...
    applyPendingBuilderChange(update?: any) {
      ...
      morphoCore().then((morpho) => {
        const jsxJson = morpho.builderContentToMorphoComponent(builderJson);
        state.code = morpho.componentToMorpho()({ component: jsxJson });
    ...
    async updateOutput() {
      try {
        ...
        const { parseSvelte, parseJsx } = await morphoCore();
        ...
        const { componentToBuilder } = await morphoCore();
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Image alt="Morpho Logo" src={'/morpho-logo-white.png'} width={130} height={40} />
            </a>
            <div
              css={{
                marginLeft: 'auto',
          ...
          >
            ...
            >
              ...
              >
                ...
                <Tab label={<TabLabelWithIcon label="Morpho" />} value="morpho" />
                <Tab
                  label={
                    <TabLabelWithIcon
                      label="JSON"
