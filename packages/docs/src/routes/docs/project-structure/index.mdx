---
title: Project structure - Morpho
---

# Project structure

For a practical example of the below structure, check out [our example project](https://github.com/BuilderIO/morpho/tree/main/examples/basic/).
...
- `morpho.config.js` contains general and per-target [configuration](/docs/configuration/). It is used by `morpho build`.
