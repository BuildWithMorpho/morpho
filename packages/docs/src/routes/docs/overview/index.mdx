...
[Morpho](https://github.com/BuilderIO/morpho) is an open-source tool that transforms JSX components into fully functional components for frameworks like Angular, React, Qwik, Vue, Svelte, Solid, and React Native.
...
With Morpho, you can streamline your workflow and reduce redundancy without compromising the quality of your design system. Morpho ensures that your design language speaks clearly and consistently, whether you're working in React, Vue, or any other framework.

By simplifying the development process through having one singular source of truth, Morpho accelerates project timelines, allowing your team to focus more on innovation and less on integration.
...
Although web components offer a modular and reusable approach to UI elements, these challenges can limit their viability. However, if supporting web components is a requirement, you can use Morpho to generate them from a single source of truth. Morpho supports [Lit](https://lit.dev/), [Stencil](https://stenciljs.com/), and raw web components as outputs.

### Integration with Figma

Morpho integrates with Figma to sync your design systems in Figma to code.
