import { JSX } from '@builder.io/morpho/jsx-runtime';
...
export const useStore = <T>(obj: T): T => {
  throw new Error('useStore: Morpho hook should have been compiled away');
  return obj as T;
};
export const useState = <T>(obj: T): [T, (value: T) => void] => {
  throw new Error('useState: Morpho hook should have been compiled away');
  return null as any;
};
export const useRef = <T>(obj?: null | void | T) => {
  throw new Error('useRef: Morpho hook should have been compiled away');
...
export const onMount = (fn: () => any) => {
  throw new Error('onMount: Morpho hook should have been compiled away');
  return null as any;
};
...
export const useMetadata = (obj: object) => {
  throw new Error('useMetadata: Morpho hook should have been compiled away');
  return null as any;
};
