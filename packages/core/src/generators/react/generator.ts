...
function provideContext(json: MorphoComponent, options: ToReactOptions): string | void {
...
const getDefaultImport = (json: MorphoComponent, options: ToReactOptions): string => {
...
const isRSC = (json: MorphoComponent, options: ToReactOptions) => {
...
const checkShouldAddUseClientDirective = (json: MorphoComponent, options: ToReactOptions) => {
