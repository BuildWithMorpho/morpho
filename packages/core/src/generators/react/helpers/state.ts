...
export const getUseStateCode = (json: MorphoComponent, options: ToReactOptions) => {
...
export const updateStateSetters = (json: MorphoComponent, options: ToReactOptions) => {
  if (options.stateType !== 'useState') {
    return;
  }
...
export const getDefaultImport = (options: ToReactOptions, json: MorphoComponent): string => {
