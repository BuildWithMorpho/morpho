...
function getContextString(component: MorphoComponent, options: ToSolidOptions) {
  let str = '';
...
const collectClassString = (json: MorphoNode, options: ToSolidOptions): string | null => {
...
const getRefsString = (json: MorphoComponent) =>
