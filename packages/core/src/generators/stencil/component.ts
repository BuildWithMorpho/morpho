...
import { BaseHook, MorphoState } from '@/types/morpho-component';
...
export const componentToStencil: TranspilerGenerator<ToStencilOptions> = (
  ...
  return ({ component }) => {
    ...
    const defaultProps: MorphoState | undefined = json.defaultProps;
    ...
    if (json.meta.useMetadata?.tagName) {
      // Deprecated option, we shouldn't use this, instead change the name of your Morpho component
