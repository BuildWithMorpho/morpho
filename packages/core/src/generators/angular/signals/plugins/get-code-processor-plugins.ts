...
import { ForNodeName } from '@/types/morpho-node';
...
const addToImportCall = (json: MorphoComponent, importName: string) => {
...
const transformBindings = (json: MorphoComponent, code: string): string => {
  return babelTransformExpression(code, {
    BlockStatement() {
      console.error(`
