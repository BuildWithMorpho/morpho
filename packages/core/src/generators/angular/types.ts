...
export interface ToAngularOptions extends BaseTranspilerOptions {
  ...
  experimental?: {
    ...
    inject?: boolean;
    outputs?: (json: MorphoComponent, variableName: string) => string;
  };
}
...
export type AngularMetadata = {
   ...
   * Create a new PR inside [event-handlers.ts](https://github.com/BuilderIO/morpho/blob/main/packages/core/src/helpers/event-handlers.ts) to fix it for all.
   */
  nativeEvents?: string[];
  /**
