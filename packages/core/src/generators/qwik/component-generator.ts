...
function emitTagNameHack(file: File, component: MorphoComponent) {
...
function emitJSX(file: File, component: MorphoComponent, topLevelElement: string | null) {
...
const CODE_PREFIX = '@builder.io/morpho/';
 ...
 * @param component
 */
function getTopLevelElement(component: MorphoComponent): string | null {
  if (component.children?.length === 1) {
    const child = component.children[0];
    if (child['@type'] === '@builder.io/morpho/node' && startsLowerCase(child.name)) {
      return child.name;
    }
  }
  return null;
