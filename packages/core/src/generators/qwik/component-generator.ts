...
function emitExports(file: File, component: MorphoComponent) {
...
function emitTagNameHack(file: File, component: MorphoComponent, metadataValue: unknown) {
...
function emitUseTask(file: File, component: MorphoComponent) {
...
function emitUseCleanup(file: File, component: MorphoComponent) {
...
function emitJSX(file: File, component: MorphoComponent, mutable: string[]) {
...
function emitUseContextProvider(file: File, component: MorphoComponent) {
...
function emitUseContext(file: File, component: MorphoComponent) {
...
function emitUseRef(file: File, component: MorphoComponent) {
  Object.keys(component.refs).forEach((refKey) => {
    file.src.emit(`const `, refKey, '=', file.import(file.qwikModule, 'useRef').localName, '();');
  });
}

function emitUseStyles(file: File, component: MorphoComponent): string {
...
function getLexicalScopeVars(component: MorphoComponent) {
  return ['props', 'state', ...Object.keys(component.refs), ...Object.keys(component.context.get)];
}

function emitImports(file: File, component: MorphoComponent) {
...
function emitStateMethods(
  file: File,
  componentState: MorphoComponent['state'],
  lexicalArgs: string[],
): StateInit {
