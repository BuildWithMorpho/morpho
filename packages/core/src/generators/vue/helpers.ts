...
import { ContextSetInfo, MorphoComponent } from '../../types/morpho-component';
...
const getAllRefs = (component: MorphoComponent) => {
...
function processRefs(input: string, component: MorphoComponent, options: ToVueOptions) {
...
function prefixMethodsWithThis(input: string, component: MorphoComponent, options: ToVueOptions) {
...
export const getContextValue =
  ({ options, json }: { options: ToVueOptions; json: MorphoComponent }) =>
...
export const getContextProvideString = (json: MorphoComponent, options: ToVueOptions) => {
  return `{
