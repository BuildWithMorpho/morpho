...
const stringifyBinding =
  (node: MorphoNode, options: ToVueOptions) =>
...
const stringifySpreads = ({ node, spreadType }: { node: MorphoNode; spreadType: SpreadType }) => {
...
const getBlockBindings = (node: MorphoNode, options: ToVueOptions) => {
