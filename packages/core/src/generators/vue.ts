...
const NODE_MAPPERS: {
  [key: string]: ((json: MorphoNode, options: ToVueOptions) => string) | undefined;
} = {
...
export const blockToVue = (node: MorphoNode, options: ToVueOptions): string => {
