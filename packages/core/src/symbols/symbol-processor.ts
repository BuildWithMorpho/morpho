...
export function convertBuilderElementToMorphoComponent(
  element: BuilderElement,
): MorphoComponent | null {
  ...
  const morphoComponent: MorphoComponent = {
    ...builderContentToMorphoComponent(elContent, {
      includeBuilderExtras: true,
      preserveTextBlocks: true,
    }),
    name: componentName,
  };
  morphoComponent.meta.builderElId = element.id;
