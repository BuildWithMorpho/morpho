...
export interface BlockSlot {
  [key: string]: BlockSlot | BlockSlot[] | MorphoNode | MorphoNode[];
}
...
export type MorphoNode = BaseNode | ForNode | ShowNode;

export const checkIsForNode = (node: MorphoNode): node is ForNode => node.name === ForNodeName;

export const checkIsShowNode = (node: MorphoNode): node is ShowNode => node.name === ShowNodeName;
