// A real Morpho application usually has a set of targets to include here;
...
// during development to check if Morpho is ready
...
module.exports = {
  files: 'src/**',
  targets,
  // Each run needs a separate output dest, as Morpho clears it first.
  dest: [outputDir],
  options: {
