// Morpho doesn't yet generate the needed Angular module, so we have a module
...
writeFileSync('angular_src/app/morpho-component-list.ts', output);

// morpho-component-list;
